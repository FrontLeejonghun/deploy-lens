...
test('a stalled font does not prevent fallback capture or reveal a masked element', async () => {
  const server = http.createServer((request, response) => {
    ...
    response.end(
      '<style>@font-face{font-family:Pending;src:url(/stalled.woff2)}body{margin:0;font-family:Pending,Arial}#private{position:absolute;left:20px;top:20px;width:100px;height:100px;background:red}#private span{visibility:visible}</style><div id="private"><span>PRIVATE</span></div><p>Public page</p>',
    );
  });
